...
![](https://github.com/mottzz87/XrayR/actions/workflows/release.yml/badge.svg)
![](https://github.com/mottzz87/XrayR/actions/workflows/docker.yml/badge.svg)
[![Github All Releases](https://img.shields.io/github/downloads/XrayR-project/XrayR/total.svg)]()

[Iranian(farsi) README](https://github.com/mottzz87/XrayR/blob/master/README_Fa.md), [Vietnamese(vi) README](https://github.com/mottzz87/XrayR/blob/master/README-vi.md), [English(en) README](https://github.com/mottzz87/XrayR/blob/master/README-en.md)
...
```
wget -N https://raw.githubusercontent.com/mottzz87/XrayR-release/master/install.sh && bash install.sh
```
...
[Mozilla Public License Version 2.0](https://github.com/mottzz87/XrayR/blob/master/LICENSE)
